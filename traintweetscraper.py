...
#Twitter API credentials - these have been left empty
#The code will not work unless you complete these with your own keys
consumer_key =
consumer_secret =
access_key =
access_secret =
...
accountslist = ['tfwrail','c2c_Rail','chilternrailway','EMTrains','TLRailUK','GNRailUK','SouthernRailUK','GWRHelp','greateranglia','ga_mainline','ga_regional','ga_westanglia','Stansted_Exp','HeathrowExpress','LNER','LDNOverground','merseyrail','networkrail','northernassist','ArrivaTW','ScotRail','SW_Railway','SW_Help','Se_Railway','TfLRail','NRE_TfLRail','Elizabethline','TPEAssist','VirginTrains','LNRailway','WestMidRailway','nationalrailenq']
#The table for results is named twice in the code again, so it's quicker to name it once, here, each time you use a new list:



namethetablehere = "traincompanytweets"
for account in accountslist[:13]:
